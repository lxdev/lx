/*!
 * Lazy Load Images on scrolling the page 
 *
 * (c) 2013 Balraj Selvakumar.
 */

lazyloadetStarts();
function lazyloadetStarts(){
(function() {
      ...
      while (i < lazyLoader.cache.length) {
        ...
        if ((imagePosition >= range.min - imageHeight) && (imagePosition <= range.max)) {
          ...
          image.onload = function() {
             this.className = this.className + ' lazy-loaded' ;
           };
