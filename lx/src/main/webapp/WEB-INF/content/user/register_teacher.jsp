...
<%	
	...
	String actionUrl = basePath + "/user/register_teacher";
%>
		...
		<script>
			...
			var setTimeGo = function(){
				timeOut = setInterval(function(){
					var _second = parseInt($("#rest_second").val());
					if(_second > 0){
						$("#rest_second").val(_second-1);
					}else {
			        ...
			        <div class="form-group">
			        	<div class="col-xs-12">
				            <div class="control-wrapper">
				            	...
				            	<input type="text" class="form-control" id="rest_second" name="rest_second" value="60" style="display:none;"/>
				            </div>
			          	</div>
			        </div>
			        <div class="form-group">
