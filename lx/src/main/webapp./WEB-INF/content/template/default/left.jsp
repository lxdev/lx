		...
		<div id=leftbar>
			...
			<div id=leftbar_left style="border: 0px gray solid">
				...
				<div id="tab18" class="leftcss" onclick="setTab(&quot;tab&quot;,18)">
					<img src="/lx/plugin/base_css/images/menu/img_dark_guide.gif"></div>
				...
				<div id="menu" style="border: 0px yellow solid">
					...
					<div id="60" class="has_children highlight">
						<span id="60_a" class="has_node">
							<img border="0" src="/lx/plugin/base_css/images/menu/item_2.gif"></span>
						<div class="node_6" style="display: block;">
							<div class="left_noadd">&nbsp;</div>
							<div class="right_word">
								<a class="nochosea" href="/lx/manage/guide_option" name="/manage/guide_option" target="main">选项设置</a>
							</div>
						</div>
						<div class="node_4" style="display: block;">
							<div class="left_noadd">&nbsp;</div>
							<div class="right_word">
								<a class="nochosea" href="/lx/manage/guide_specialty" name="/manage/guide_specialty" target="main">自定义专业</a>
							</div>
						</div>
						<div class="node_4" style="display: block;">
							<div class="left_noadd">&nbsp;</div>
							<div class="right_word">
								<a class="nochosea" href="/lx/manage/guide" name="/manage/guide" target="main">攻略设置</a>
							</div>
						</div>
					</div>
